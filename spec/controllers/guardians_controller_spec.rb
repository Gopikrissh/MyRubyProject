...
RSpec.describe GuardiansController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested guardian as @guardian" do
      guardian = Guardian.create! valid_attributes
      get :show, {:id => guardian.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested guardian as @guardian" do
      guardian = Guardian.create! valid_attributes
      get :edit, {:id => guardian.to_param}, valid_session
      expect(assigns(:guardian)).to eq(guardian)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Guardian" do
        expect {
          post :create, {:guardian => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved guardian as @guardian" do
        post :create, {:guardian => invalid_attributes}, valid_session
        expect(assigns(:guardian)).to be_a_new(Guardian)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested guardian" do
        guardian = Guardian.create! valid_attributes
        put :update, {:id => guardian.to_param, :guardian => new_attributes}, valid_session
        guardian.reload
      ...
      it "assigns the requested guardian as @guardian" do
        guardian = Guardian.create! valid_attributes
        put :update, {:id => guardian.to_param, :guardian => valid_attributes}, valid_session
        expect(assigns(:guardian)).to eq(guardian)
      end
    ...
    context "with invalid params" do
      it "assigns the guardian as @guardian" do
        guardian = Guardian.create! valid_attributes
        put :update, {:id => guardian.to_param, :guardian => invalid_attributes}, valid_session
        expect(assigns(:guardian)).to eq(guardian)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested guardian" do
      guardian = Guardian.create! valid_attributes
      expect {
        delete :destroy, {:id => guardian.to_param}, valid_session
      }.to change(Guardian, :count).by(-1)
    end
